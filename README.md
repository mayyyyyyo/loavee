...
body{
  ...
  background:
  radial-gradient(circle at top,#1d2b44 0%,#111827 55%,#070b12 100%);
...
.yes{
  background:
  linear-gradient(135deg,#ffffff,#dce9ff);
...
<div class="card">
  ...
  <div class="answer-box" id="answerBox">
    ...
    <div class="answer-buttons">
      ...
      <button class="yes" onclick="sendAnswer('YES 🤍')">
        Yes 🤍
      </button>

      <button class="no" onclick="sendAnswer('NO 🙂')">
        No
      </button>
